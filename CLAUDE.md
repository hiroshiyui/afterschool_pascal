...
- **It is specified, and the specification is enforced.** `tests/spec/` takes
  ...
  **114 of the spec's 118 testable clauses** are cited by a scenario, and the
