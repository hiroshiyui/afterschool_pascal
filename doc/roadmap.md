...
trap, `references`, and the examples. The examples were taken first
(ADR-0295), and paid twice as the sentence said: twelve cases, and seven
findings in *Writing a daily program* above.
