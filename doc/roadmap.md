...
Both standards are **complete** and the bootstrap is **done**, so most of this
file is a record rather than a plan. It is in two parts: **Part I** is what
happened, in the order it happened; **Part II** is what is still open, most
consequential first.

If you are here for

- **what the language has today** → skim Part I's last chapter, *The goal,
  restated*, and Stage 2's [feature
  list](#the-features-in-the-order-they-landed);
- **what is undecided** → Part II, which is the whole of it;
- **why something is the way it is** → find the ADR number here, then read
  `doc/adr/`. This file says what happened; the records say *why*, and what the
  alternatives were.

**Part I — how it got here**
...
**Part I — how it got here.** Eight chapters in the order the work actually
happened, from the compiler that could build itself to the dialect being
built on top of it. All of it is settled; read it when you want to know why
something is the shape it is.
...
**Part II — what is open.** Three chapters, most consequential first. This is
