...
- **B1. Cite the clause**, in the code comment and the commit message. A rule
  ...
  - **The number is checked to exist** by `clause-citations` (ADR-0164), which
    is the half that *can* be mechanical: over the citations in the tree — 10 472 across 1679 files as this is written, and the gate prints the pair — it asks whether
