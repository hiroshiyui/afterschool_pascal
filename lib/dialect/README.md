...
These **twenty-five** modules use constructs no standard Pascal has, and
...
The other thirteen are pure computation over what those hand them, here
because they are dialect-only for ADR-0119's reason and not because they touch
...
The rule below is about those other thirteen.
