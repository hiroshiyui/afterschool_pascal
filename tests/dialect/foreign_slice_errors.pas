...
function R2(fd: integer; var b: array of boolean): int64; external 'read';

{ A record's layout is this compiler's, and nothing on the other side agrees
  to it. }
function R3(fd: integer; var b: array of point): int64; external 'read';
...
function R4(fd: integer; b: array of char): int64; external 'read';
